      ...
      <SectionMain>
        ...
        <CardBox>
            ...
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {discussion_boards.participants &&
                      Array.isArray(discussion_boards.participants) &&
                      discussion_boards.participants.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
              ...
              {!discussion_boards?.participants?.length && (
          ...
          <div className={'mb-4'}>
            ...
            <p>{discussion_boards?.organizations?.name ?? 'No data'}</p>
          </div>
