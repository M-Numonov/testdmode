...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.analytics_organizations =
      await organizations.getAnalytics_organizations({
        transaction,
      });

    output.courses_organizations = await organizations.getCourses_organizations(
      {
        transaction,
      },
    );

    output.discussion_boards_organizations =
      await organizations.getDiscussion_boards_organizations({
        transaction,
      });
    ...
    output.instructors_organizations =
      await organizations.getInstructors_organizations({
        transaction,
      });

    output.students_organizations =
      await organizations.getStudents_organizations({
        transaction,
      });
