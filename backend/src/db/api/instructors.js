...
module.exports = class InstructorsDBApi {
  static async create(data, options) {
    ...
    await instructors.setOrganizations(data.organizations || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.organizations = await instructors.getOrganizations({
      transaction,
    });
  ...
  static async findAll(filter, globalAccess, options) {
    ...
    if (filter) {
      ...
      if (filter.first_name) {
        where = {
          ...where,
          [Op.and]: Utils.ilike('instructors', 'first_name', filter.first_name),
        };
      }
      ...
      if (filter.last_name) {
        where = {
          ...where,
          [Op.and]: Utils.ilike('instructors', 'last_name', filter.last_name),
        };
      }
  ...
  static async findAllAutocomplete(
    ...
    if (query) {
      where = {
        [Op.or]: [
          { ['id']: Utils.uuid(query) },
          Utils.ilike('instructors', 'first_name', query),
        ],
      };
    }
