...
module.exports = function (sequelize, DataTypes) {
  ...
  discussion_boards.associate = (db) => {
    db.discussion_boards.belongsToMany(db.users, {
      as: 'participants',
      foreignKey: {
        name: 'discussion_boards_participantsId',
      },
      constraints: false,
      through: 'discussion_boardsParticipantsUsers',
    });
    ...
    db.discussion_boards.belongsTo(db.organizations, {
      as: 'organizations',
      foreignKey: {
