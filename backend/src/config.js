...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: 'e2a73f9c14d74b66366fa824ed9a6786',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'testdmode <app@flatlogic.app>',
  ...
  project_uuid: 'ef63ac8a-35d4-45a4-8a05-0e94b07acdc8',
  flHost:
...
config.pexelsQuery = 'abstract education concept art';
config.host =
